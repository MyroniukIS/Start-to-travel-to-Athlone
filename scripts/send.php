<!-- <?php
//     mail('knopkakyrs@gmail.com', $_POST['FirstName'], $_POST['LastName'], $_POST['Email'], $_POST['PhoneNumber'],, $_POST['Message']);
// ?>
...
if (isset($_POST['email'])) {
    ...
    $email_to = "knopkakyrs@gmail.com";
    $email_subject = "Hello! You've got a new submission";
    ...
    $email_message .= "NameLast: " . clean_string($nameLast) . "\n";
